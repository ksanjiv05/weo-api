...
//   // Navigate to the URL you want to convert to PDF.
//   await page.goto(url, { waitUntil: "networkidle0" });
//   // Generate a PDF file of the page.
//   await page.pdf({
//     path: "example.pdf", // The file path to save the PDF to.
...
// Usage
// generatePDF("https://www.w3schools.com/html/html_tables.asp", "google.pdf")
